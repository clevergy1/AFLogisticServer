...
#Region "methods"
        Public Shared Function Add(CronId As Integer, ProfileY As Integer, ProfileNr As Integer, descr As String, ProfileData As Decimal()) As Boolean
            ...
            Dim _d As hs_amb_Profile_Descr = hs_amb_Profile_Descr.Read(CronId, ProfileNr)
            If _d Is Nothing Then
                hs_amb_Profile_Descr.Add(CronId, ProfileNr, descr)
            Else
                _d = Nothing
            End If

            Return DataAccessHelper.GetDataAccess.hs_amb_Profile_Add(CronId, ProfileY, ProfileNr, descr, ProfileData)
        End Function

        Public Shared Function Clear(CronId As Integer) As Boolean
            If CronId <= 0 Then Return False
            Return DataAccessHelper.GetDataAccess.hs_amb_Profile_Clear(CronId)
        End Function

        Public Shared Function getProfile(hsid As Integer, CronCod As String, ProfileYear As Integer, ProfileNr As Integer) As hs_amb_Profile
                ...
                If retCode = "0000" Then
                    ...
                    If dataLen > 0 Then
                        ...
                        Else
                            ...
                            End If
                            SCP.BLL.hs_amb_Profile.Add(retVal.CronId, retVal.ProfileY, retVal.ProfileNr, profileDescr, retVal.ProfileData)
        ...
        Public Shared Function getProfileById(CronId As Integer, ProfileYear As Integer, ProfileNr As Integer) As hs_amb_Profile
            Dim retVal As hs_amb_Profile = Nothing
        ...
        Public Shared Function List(CronId As Integer, ProfileY As Integer) As List(Of hs_amb_Profile)
            If CronId <= 0 Then Return Nothing
            If ProfileY <= 0 Then Return Nothing
            'Return DataAccessHelper.GetDataAccess.hs_amb_Profile_List(CronId, ProfileY)

            Dim retVal As New List(Of hs_amb_Profile)
            For x As Integer = 0 To 10
                Dim _obj As hs_amb_Profile = DataAccessHelper.GetDataAccess.hs_amb_Profile_Read(CronId, ProfileY, x)
        ...
        Public Shared Function Read(CronId As Integer, ProfileY As Integer, ProfileNr As Integer) As hs_amb_Profile
            If CronId <= 0 Then Return Nothing
            If ProfileY <= 0 Then Return Nothing
            If ProfileNr < 0 Then Return Nothing
            Return DataAccessHelper.GetDataAccess.hs_amb_Profile_Read(CronId, ProfileY, ProfileNr)
        End Function
        ...
        Public Shared Function Update(CronId As Integer, ProfileY As Integer, ProfileNr As Integer, descr As String, ProfileData As Decimal()) As Boolean
            ...
            If ProfileNr < 0 Then Return False
            If ProfileData.Length <= 0 Then Return False
            Return DataAccessHelper.GetDataAccess.hs_amb_Profile_Update(CronId, ProfileY, ProfileNr, descr, ProfileData)
        End Function
