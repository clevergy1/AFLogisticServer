...
Namespace SCP.BLL
    Public Class Zrel_replacement_history
...
#Region "methods"
        Public Shared Function Add(ParentId As Integer, marcamodello As String, installationDate As Date, note As String, userName As String) As Boolean
            ...
            Return DataAccessHelper.GetDataAccess.Zrel_replacement_history_Add(ParentId, marcamodello, installationDate, note, userName)
        End Function

        Public Shared Function Del(Id As Integer) As Boolean
            If Id <= 0 Then Return False
            Return DataAccessHelper.GetDataAccess.Zrel_replacement_history_Del(Id)
        End Function

        Public Shared Function List(ParentId As Integer) As List(Of Zrel_replacement_history)
            If ParentId <= 0 Then Return Nothing
            Return DataAccessHelper.GetDataAccess.Zrel_replacement_history_List(ParentId)
        End Function

        Public Shared Function Read(Id As Integer) As Zrel_replacement_history
            If Id <= 0 Then Return Nothing
            Return DataAccessHelper.GetDataAccess.Zrel_replacement_history_Read(Id)
        End Function
        ...
        Public Shared Function Update(Id As Integer, marcamodello As String, installationDate As Date, note As String, userName As String) As Boolean
            If Id <= 0 Then Return False
            If installationDate.Year <= 1900 Then Return False
            Return DataAccessHelper.GetDataAccess.Zrel_replacement_history_Update(Id, marcamodello, installationDate, note, userName)
        End Function
#End Region
