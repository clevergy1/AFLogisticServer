...
#Region "methods"
        Public Shared Function Add(hsId As Integer,
            ...
            If String.IsNullOrEmpty(Cod) Then
                Return False
            End If
            Return DataAccessHelper.GetDataAccess.LuxM_last_Add(hsId, Cod, lastLog, lastdtLog)
        ...
        Public Shared Function Upd(hsId As Integer,
            ...
            If String.IsNullOrEmpty(Cod) Then
                Return False
            End If
            Return DataAccessHelper.GetDataAccess.LuxM_last_Upd(hsId, Cod, lastLog, lastdtLog)

        End Function

        Public Shared Function Read(hsId As Integer, Cod As String) As LuxM_last
            If hsId <= 0 Then
                Return Nothing
            End If
            Return DataAccessHelper.GetDataAccess.LuxM_last_Read(hsId, Cod)
        End Function
        ...
        Public Shared Function Upsert(hsId As Integer, Cod As String, lastLog As Integer, lastdtLog As Date) As Boolean
            ...
            If String.IsNullOrEmpty(Cod) Then
                Return False
            End If
            Dim _obj As LuxM_last = Read(hsId, Cod)
