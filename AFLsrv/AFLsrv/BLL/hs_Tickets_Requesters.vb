...
Namespace SCP.BLL
    Public Class hs_Tickets_Requesters
...
#Region "methods"
        Public Shared Function Add(hsId As Integer, IdContatto As Integer) As Boolean
            ...
            If IdContatto <= 0 Then
                Return False
            End If
            Return DataAccessHelper.GetDataAccess.hs_Tickets_Requesters_Add(hsId, IdContatto)
        End Function
        ...
        Public Shared Function Del(Id As Integer) As Boolean
            If Id <= 0 Then
                Return False
            End If
            Return DataAccessHelper.GetDataAccess.hs_Tickets_Requesters_Del(Id)
        End Function

        Public Shared Function List(hsId As Integer) As List(Of hs_Tickets_Requesters)
            If hsId <= 0 Then
                Return Nothing
            End If
            Return DataAccessHelper.GetDataAccess.hs_Tickets_Requesters_List(hsId)
        End Function

        Public Shared Function Read(Id As Integer) As hs_Tickets_Requesters
            If Id <= 0 Then
                Return Nothing
            End If
            Return DataAccessHelper.GetDataAccess.hs_Tickets_Requesters_Read(Id)
        End Function
#End Region
